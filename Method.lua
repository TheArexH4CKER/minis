...
_G.GCARD_PACK_TO_BUY = "BIG Pack"
_G.GLOOTBOXES = {"BIG Pack"}
...
_G.GMAIL_ITEMS = {
  ["Huge Arcane Dominus Cards"] = {Class = "Card", Id = "Huge Arcane Dominus Card", MinAmount = 1, AllVariants = true},
  ["Titanic Signature BIG Maskot Cards"] = {Class = "Card", Id = "Titanic BIG Maskot Card", MinAmount = 1, AllVariants = true},
