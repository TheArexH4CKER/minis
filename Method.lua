...
getgenv().Configuration = {
    ...
    ['Event'] = {
        ...
        ['Craft Gift'] = false,
        ['Upgrades'] = { "LuckyRaidDamage", "LuckyRaidPetSpeed", "LuckyRaidBossHugeChances", "LuckyRaidPets", "LuckyRaidBetterLoot", "LuckyRaidHugeChest",  "LuckyRaidBossTitanicChances", "LuckyRaidTitanicChest" },
    },
    --['Debug'] = {false, false},
