...
getgenv().Configuration = {
    ...
    ['Event'] = {
        ...
        ['Craft Gift'] = false,
        ['Upgrades'] = { "LuckyRaidDamage", "LuckyRaidPetSpeed", "LuckyRaidBossHugeChances", "LuckyRaidPets", "LuckyRaidHugeChest", "LuckyRaidBetterLoot", "LuckyRaidBossTitanicChances", "LuckyRaidTitanicChest" },
    },
    --['Debug'] = {false, false},
